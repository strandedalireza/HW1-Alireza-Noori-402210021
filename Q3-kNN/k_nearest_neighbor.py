...
class KNearestNeighbor(object):
    ...
    def compute_distances_two_loops(self, X):
        ...
        dists = np.zeros((num_test, num_train))  # Initialize distance matrix
        
        for i in range(num_test):
            for j in range(num_train):
                # Compute the Euclidean distance between the i-th test point and j-th training point
    ...
    def compute_distances_one_loop(self, X):
        ...
        Inputs:
        - X: A numpy array of shape (num_test, D) where D is the dimension of the data.
        ...
        for i in range(num_test):
            # Compute the distance from the ith test point to all training points
    ...
    def compute_distances_no_loops(self, X):
        ...
        # Calculate the L2 distance using broadcasting
        # dists = np.sqrt(np.sum(X^2) + np.sum(self.X_train^2) - 2 * X * self.X_train)
